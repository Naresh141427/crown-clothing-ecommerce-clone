...
export const signInFailed = (err) => createAction(USER_ACTION_TYPE.SIGN_IN_FAILED, err)
...
export const signUpailed = (err) => createAction(USER_ACTION_TYPE.SIGN_UP_FAILED, err)
...
export const signOutFailed = (err) => createAction(USER_ACTION_TYPE.SIGN_OUT_FAILED, err)